...
class BranchesBox(BoxLayout):
    ...
    def remove_rename_widget(self, path):
        """
    ...
    def remove_newbranch_widget(self, path):
        """
    ...
    def clear_buttonactions(self, path):
        """
...
class ChangesBox(BoxLayout):
    ...
    def get_unpushedcommits(self, path):
        """
...
class HistoryBox(BoxLayout):
    ...
    def load_collapsed_diff(self, path):
